...
class BossbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def loadPlaceGeom(self, zoneId):
        ...
        if zoneId == ToontownGlobals.BossbotHQ:
            ...
            self.theMoleHole = loader.loadModel('phase_12/models/bossbotHQ/mole_hole')
            self.theMoleHole.setPosHpr(84, 112, 0.025, -178, 0, 0)
            self.theMoleHole.reparentTo(self.geom)

            self.groundMole = loader.loadModel('phase_12/models/bossbotHQ/mole_cog')
            self.groundMole.setPos(0, 0, 0)
            self.groundMole.reparentTo(self.theMoleHole)
