...
# ===============================================================================
    ...
    def changePartyStatusResponse(self, partyId, newPartyStatus, errorCode, beansRefunded):
        ...
        """
        self.notify.debug("changePartyStatusResponse : partyId=%s newPartyStatus=%s errorCode=%s beansRefunded=%s" % (partyId, newPartyStatus, errorCode, beansRefunded))
    ...
    def sendAvatarToParty(self, hostId):
        ...
        """
        self.notify.debug("sendAvatarToParty hostId = %s" % hostId)
    ...
    def sendShardIdZoneIdToAvatar(self, shardId, zoneId):
        ...
        """
        self.notify.debug("sendShardIdZoneIdToAvatar shardId = %s  zoneId = %s" % (shardId, zoneId))
