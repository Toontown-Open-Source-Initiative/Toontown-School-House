...
class Quest:
    ...
    def checkNumClerks(self, num):
        self.check(num > 0, 'invalid number of clerks: %s' % str(num))

    def checkNumClubPresidents(self, num):
        self.check(num > 0, 'invalid number of club presidents: %s' % str(num))
...
class ClerkQuest(CogQuest):
    def __init__(self, id, quest):
        CogQuest.__init__(self, id, quest)
        self.checkNumClerks(self.quest)
...
class ClubPresidentQuest(CogQuest):
    def __init__(self, id, quest):
        CogQuest.__init__(self, id, quest)
        self.checkNumClubPresidents(self.quest)
...
QuestDict = {
    ...
    3218: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5010, VeryEasy, 'gh'), Same, Same, NA, 3219, TTLocalizer.QuestDialogDict[3218]),
    3219: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5010, VeryEasy, 'ms'), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[3219]),
    3244: (DG_TIER, Start, (RecoverItemQuest, Anywhere, 1, 5010, VeryEasy, 'ac'), ToonHQ, ToonHQ, NA, 3245, TTLocalizer.QuestDialogDict[3244]),
    3245: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5010, VeryEasy, 'bs'), Same, Same, NA, 3246, TTLocalizer.QuestDialogDict[3245]),
    3246: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5010, VeryEasy, 'sd'), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[3246]),
    ...
    3600: (DG_TIER + 1, Start, (CogQuest, ToontownGlobals.DaisyGardens, 8, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3601: (DG_TIER + 1, Start, (CogQuest, ToontownGlobals.DaisyGardens, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3602: (DG_TIER + 1, Start, (CogQuest, ToontownGlobals.DaisyGardens, 12, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3603: (DG_TIER + 1, Start, (CogQuest, Anywhere, 14, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3604: (DG_TIER + 1, Start, (CogQuest, Anywhere, 16, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3605: (DG_TIER + 1, Start, (CogQuest, Anywhere, 18, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3606: (DG_TIER + 1, Start, (CogQuest, Anywhere, 10, 'f'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3607: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'p'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3608: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'ym'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3609: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'mm'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3610: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'ds'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3611: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'hh'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3612: (DG_TIER + 1, Start, (CogQuest, Anywhere, 10, 'cc'), Any, ToonHQ, Any, NA, DefaultDialog),
    3613: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'tm'), Any, ToonHQ, Any, NA, DefaultDialog),
    3614: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    3615: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    3616: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    3617: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'tf'), Any, ToonHQ, Any, NA, DefaultDialog),
    3618: (DG_TIER + 1, Start, (CogQuest, Anywhere, 10, 'sc'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3619: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'pp'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3620: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'tw'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3621: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'bc'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3622: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'nc'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3623: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'mb'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3624: (DG_TIER + 1, Start, (CogQuest, Anywhere, 10, 'bf'), Any, ToonHQ, Any, NA, DefaultDialog),
    3625: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'b'), Any, ToonHQ, Any, NA, DefaultDialog),
    3626: (DG_TIER + 1, Start, (CogQuest, Anywhere, 8, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    3627: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    3628: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    3629: (DG_TIER + 1, Start, (CogQuest, Anywhere, 6, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    3630: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 10, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    3631: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 15, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    3632: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 8, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    3633: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 12, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    3634: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 4, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    3635: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 6, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    3636: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 8, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    3637: (DG_TIER + 1, Start, (CogLevelQuest, Anywhere, 12, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    3638: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 6, 'm'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3639: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 6, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    3640: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 6, 'c'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3641: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 6, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    3642: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 'm'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3643: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    3644: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 'c'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3645: (DG_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    3646: (DG_TIER + 1, Start, (CogTrackQuest, Anywhere, 14, 'm'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3647: (DG_TIER + 1, Start, (CogTrackQuest, Anywhere, 14, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    3648: (DG_TIER + 1, Start, (CogTrackQuest, Anywhere, 14, 'c'), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3649: (DG_TIER + 1, Start, (CogTrackQuest, Anywhere, 14, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    3650: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    3651: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 2, Any, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    3652: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 3, Any, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    3653: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 4, Any, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    3654: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 2, 'm', 2), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3655: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 2, 's', 2), Any, ToonHQ, Any, NA, DefaultDialog),
    3656: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 2, 'c', 2), Any, ToonHQ, OBSOLETE, NA, DefaultDialog),
    3657: (DG_TIER + 1, Start, (BuildingQuest, Anywhere, 2, 'l', 2), Any, ToonHQ, Any, NA, DefaultDialog),
    3658: (DG_TIER + 1, Start, (VisitQuest,), Any, 5305, NA, 3659, TTLocalizer.QuestDialogDict[3658]),
    3659: (DG_TIER + 1, Cont, (DeliverGagQuest, 5, ToontownBattleGlobals.SQUIRT_TRACK, 3), Same, Same, NA, 3660, TTLocalizer.QuestDialogDict[3659]),
    3660: (DG_TIER + 1, Cont, (BuildingQuest, ToontownGlobals.DaisyGardens, 3, 's', 1), Same, Same, 3000, NA, TTLocalizer.QuestDialogDict[3660]),
    3661: (DG_TIER + 1, Start, (VisitQuest,), Any, 5202, NA, 3662, TTLocalizer.QuestDialogDict[3661]),
    3662: (DG_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 6, 5018, Easy, 'gh'), Same, Same, 3001, NA, TTLocalizer.QuestDialogDict[3662]),
    3663: (DG_TIER + 1, Start, (VisitQuest,), Any, 5308, NA, 3664, TTLocalizer.QuestDialogDict[3663]),
    3664: (DG_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 3, 5019, Medium, 'tf'), Same, Same, 3002, NA, TTLocalizer.QuestDialogDict[3664]),
    3665: (DG_TIER + 1, Start, (VisitQuest,), Any, 5120, NA, 3666, TTLocalizer.QuestDialogDict[3665]),
    3666: (DG_TIER + 1, Cont, (DeliverGagQuest, 1, ToontownBattleGlobals.THROW_TRACK, 3), Same, Same, NA, 3667, TTLocalizer.QuestDialogDict[3666]),
    3667: (DG_TIER + 1, Cont, (CogLevelQuest, Anywhere, 20, 6), Same, Same, 3003, NA, TTLocalizer.QuestDialogDict[3667]),
    3668: (DG_TIER + 1, Start, (VisitQuest,), Any, 5119, NA, 3669, TTLocalizer.QuestDialogDict[3668]),
    3669: (DG_TIER + 1, Cont, (RecoverItemQuest, ToontownGlobals.SellbotFactoryInt, 10, 5020, VeryHard, Any), Same, Same, 3004, NA, TTLocalizer.QuestDialogDict[3669]),
    3700: (DG_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 1, 12), Any, ToonHQ, 306, NA, TTLocalizer.QuestDialogDict[3700]),
    ...
    8219: (DL_TIER + 2, OBSOLETE, (CFOQuest, ToontownGlobals.CashbotHQ, 2), Any, ToonHQ, 621, NA, DefaultDialog),
    ...
    9219: (DL_TIER + 3, OBSOLETE, (CFOQuest, ToontownGlobals.CashbotHQ, 3), Any, ToonHQ, 622, NA, DefaultDialog),
    9500: (DL_TIER + 3, Start, (CogQuest, ToontownGlobals.DonaldsDreamland, 100, Any), Any, ToonHQ, NA, 9501, DefaultDialog),
    ...
    10103: (ELDER_TIER, Start, (CogQuest, Anywhere, 140, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10104: (ELDER_TIER, Start, (CogQuest, Anywhere, 160, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10105: (ELDER_TIER, Start, (CogQuest, Anywhere, 180, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10106: (ELDER_TIER, Start, (CogQuest, Anywhere, 200, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10107: (ELDER_TIER, Start, (CogQuest, Anywhere, 250, Any), Any, ToonHQ, 618, NA, DefaultDialog),
    10110: (ELDER_TIER, Start, (CogTrackQuest, Anywhere, 70, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    10111: (ELDER_TIER, Start, (CogTrackQuest, Anywhere, 70, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    10112: (ELDER_TIER, Start, (CogTrackQuest, Anywhere, 70, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    10113: (ELDER_TIER, Start, (CogTrackQuest, Anywhere, 70, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    10114: (ELDER_TIER, Start, (SkelecogTrackQuest, ToontownGlobals.LawbotHQ, 50, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    10115: (ELDER_TIER, Start, (SkelecogTrackQuest, ToontownGlobals.CashbotHQ, 50, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    10116: (ELDER_TIER, Start, (SkelecogTrackQuest, ToontownGlobals.SellbotHQ, 50, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    10117: (ELDER_TIER, Start, (SkelecogQuest, Anywhere, 50), Any, ToonHQ, Any, NA, DefaultDialog),
    10118: (ELDER_TIER, Start, (SkeleReviveQuest, Anywhere, 30), Any, ToonHQ, 620, NA, DefaultDialog),
    10120: (ELDER_TIER, OBSOLETE, (VPQuest, ToontownGlobals.SellbotHQ, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    10121: (ELDER_TIER, OBSOLETE, (CFOQuest, ToontownGlobals.CashbotHQ, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    10122: (ELDER_TIER, Start, (CogLevelQuest, Anywhere, 70, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    10123: (ELDER_TIER, Start, (CogLevelQuest, Anywhere, 60, 10), Any, ToonHQ, 623, NA, DefaultDialog),
    10124: (ELDER_TIER, Start, (CogLevelQuest, Anywhere, 40, 11), Any, ToonHQ, Any, NA, DefaultDialog),
    10140: (ELDER_TIER, Start, (CogLevelQuest, Anywhere, 30, 12), Any, ToonHQ, Any, NA, DefaultDialog),
    10141: (ELDER_TIER, Start, (CogLevelQuest, Anywhere, 20, 13), Any, ToonHQ, Any, NA, DefaultDialog),
    10142: (ELDER_TIER, Start, (CogLevelQuest, Anywhere, 10, 15), Any, ToonHQ, Any, NA, DefaultDialog),
    10143: (ELDER_TIER, Start, (ClerkQuest, ToontownGlobals.LawbotHQ, 5), Any, ToonHQ, 623, NA, DefaultDialog),
    ...
    10208: (ELDER_TIER, Start, (ClubPresidentQuest, ToontownGlobals.BossbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
