...
ElevatorData = {ELEVATOR_NORMAL: {'openTime': 2.0,
                   'closeTime': 2.0,
                   'width': 3.5,
                   'countdown': bboard.get('elevatorCountdown', 1.0), #15
                   'sfxVolume': 1.0,
                   'collRadius': 5},
 ELEVATOR_VP: {'openTime': 4.0,
               'closeTime': 4.0,
               'width': 11.5,
               'countdown': bboard.get('elevatorCountdown', 1.0), #30
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ...
 ELEVATOR_CFO: {'openTime': 3.0,
                'closeTime': 3.0,
                'width': 8.166,
                'countdown': bboard.get('elevatorCountdown', 1.0), #1
                'sfxVolume': 0.7,
                'collRadius': 7.5},
 ...
 ELEVATOR_BB: {'openTime': 4.0,
               'closeTime': 4.0,
               'width': 6.3,
               'countdown': bboard.get('elevatorCountdown', 1.0), #ceo 30
               'sfxVolume': 0.7,
               'collRadius': 7.5},
