...
class DistributedVPHardmodeElevator(DistributedBossElevator.DistributedBossElevator):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedVPHardmodeElevator')
    ...
    def getDestName(self):
        return TTLocalizer.ElevatorSellBotBossHardmode
