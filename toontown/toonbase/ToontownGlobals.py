...
LawbotBossLawyerXPosOuterLimits = [-86, 9]
LawbotBossLawyerXPosInnerLimits = -18
LawbotBossLawyerYPosOuterLimits = [-35, 65]
LawbotBossLawyerYPosInnerLimits = [2, 20]
LawbotBossLawyerFlightHeightLimits = [10, 20]
LawbotBossLawyerTimeToWalk = 4
LawbotBossWantSpecificLawyers = 0
LOW_POP_JP = 0
MID_POP_JP = 100
HIGH_POP_JP = 200
LOW_POP_INTL = 399
