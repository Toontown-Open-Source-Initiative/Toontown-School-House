...
CogdoCraneIntroMovieDialogue = (("You Toons have dropped the bag on this one! We're financially funding the destruction of your Laff Barrels and you're powerless to stop us!", "You Toons are stuck in baggage claim! We're crushing your Barrels of your Laff, and there's nothing you can do about it!", "You won't be able to bag us, Toons! We're powering out offices with your Laff, and you cannot stop us!"), ('This is the Toon Resistance! These COGs have some serious baggage! Hop on a crane and fling money bags at the COGs to stop them from destroying our Laff! Good Luck!', 'Attention Toons! Put these COGs in the bag using their cranes! Knock out the COGs by tripping them up with money bags. Toon Resistance out!', 'Toon Resistance here! Bag the COGs up by using the cranes! Send money bags flying at the COGs before they can use the %s. Good luck and have fun!' % CogdoStomperName), ("Huff! I'm a Silver Sprocket Award winner, I don't need this!", "Time to bring in the big bags!", "Careful, we have some serious baggage!"))
