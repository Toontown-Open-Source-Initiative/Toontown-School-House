...
SuitFlunky = 'I cannot see correctly'
SuitPencilPusher = 'Pointy'
SuitYesman = 'Big teeth'
...
SuitColdCaller = 'Blue Guy'
SuitTelemarketer = 'Angry Guy'
SuitNameDropper = 'Pissy Cog'
...
SuitShortChange = 'Oh my God what is this name'
SuitPennyPincher = 'Mr. Krabs'
SuitTightwad = 'I am fat'
...
SuitBottomFeeder = 'Trash'
SuitBloodsucker = 'Spooky'
SuitDoubleTalker = 'Lawbot Two-Face'
...
AvatarChooserPickAToon = 'Pick  a  Toon  You  Coward!'
