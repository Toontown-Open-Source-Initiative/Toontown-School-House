...
QuestDialogDict = {160: {GREETING: '',
 ...
 5280: {GREETING: '',
        ...
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Have you found all my ice cream cones yet?'},
 5239: {QUEST: "Thanks for bringing back my ice cream cones!\x07Here's one for Smol Hare.",
        GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'You better bring that ice cream to Smol Hare before it melts.'},
 5240: {GREETING: '',
...
SuitMicromanagerS = 'a Picomanager'
...
SuitYesmanP = 'Yesmen'
SuitMicromanagerP = 'Picomanagers'
