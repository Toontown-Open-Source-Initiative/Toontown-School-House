...
ElevatorRejectBoardingParty = 'You cannot board this elevator while you are in a boarding group.'
...
BoardingPartyInform = 'Create a Boarding Group by clicking on another Toon and Inviting them.' \
                      'For this destination, Boarding Groups cannot have more than %d Toons.'
...
BoardcodePromotionLeader = 'Your group cannot board because you do not have a promotion.'
BoardcodePromotionNonLeaderSingular = 'Your group cannot board because %s does not have a promotion.'
BoardcodePromotionNonLeaderPlural = 'Your group cannot board because %s do not have a promotion.'
BoardcodeSpace = 'Your group cannot board because there are too many group members.'
