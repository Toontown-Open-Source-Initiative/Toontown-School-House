...
PetRarities2 = (('leopard', 0.005),
 ...
 ('tummy', 0.525),
 ('threeStripe', 1.0))
PetRarities = {'body': {ToontownGlobals.ToontownCentral: {'threeStripe': 0,
                                            'tummy': 100,
                                            'dots': 0},
          ToontownGlobals.DonaldsDock: {'threeStripe': 0,
                                        'tummy': 100,
                                        'dots': 0,
                                        'tigerStripe': 0},
          ToontownGlobals.DaisyGardens: {'threeStripe': 0,
                                         'tummy': 100,
                                         'dots': 0,
                                         'tigerStripe': 0,
                                         'turtle': 0},
          ToontownGlobals.MinniesMelodyland: {'threeStripe': 0,
                                              'tummy': 100,
                                              'dots': 0,
                                              'tigerStripe': 0,
                                              'turtle': 0},
          ToontownGlobals.TheBrrrgh: {'threeStripe': 0,
                                      'tummy': 100,
                                      'dots': 0,
                                      'tigerStripe': 0,
                                      'turtle': 0,
                                      'giraffe': 0},
          ToontownGlobals.DonaldsDreamland: {'threeStripe': 0,
                                             'tummy': 100,
                                             'dots': 0,
                                             'tigerStripe': 0,
                                             'turtle': 0,
