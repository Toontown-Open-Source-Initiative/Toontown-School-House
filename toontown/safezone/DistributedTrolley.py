    ...
    def fillSlot(self, index, avId):
        if avId == 0:
            ...
            if avId in self.cr.doId2do:
                ...
                track = Sequence(LerpPosInterval(toon, TOON_BOARD_TIME * 0.75, Point3(-5, -4.5 + index * 3, 1.39)), LerpHprInterval(toon, TOON_BOARD_TIME * 0.25, Point3(90, 0, 0)), Func(toon.setAnimState, 'neutral', 1.0), Func(self.clearToonTrack, avId), name=toon.uniqueName('fillTrolley'), autoPause=1)
