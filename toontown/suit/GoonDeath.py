...
def createGoonExplosion(parent, explosionPoint, scale):
    ...
    smallGearExplosion = BattleParticles.loadParticleFile('resistanceEffectSparkle.ptf')
    bigGearExplosion = BattleParticles.loadParticleFile('resistanceEffectSparkle.ptf')
