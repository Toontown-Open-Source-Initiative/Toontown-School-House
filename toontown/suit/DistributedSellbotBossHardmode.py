...
class DistributedSellbotBossHardmode(DistributedBossCog.DistributedBossCog, FSM.FSM):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedSellbotBossHardmode')
    cageHeights = [100,
     81,
     63,
     44,
    ...
    def __init__(self, cr):
        ...
        FSM.FSM.__init__(self, 'DistributedSellbotBossHardmode')
