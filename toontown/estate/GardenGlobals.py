...
FlowerColors = [(0.529, 0.137, 0.137),
 (0.988, 0.631, 0.407),
 (0.588, 0.45, 0.819),
 (0.498, 0.851, 0.941),
 (0.82, 0.737, 0.663),
...
PlantAttributes = {49: {'name': TTLocalizer.FlowerSpeciesNames[49],
 ...
 50: {'name': TTLocalizer.FlowerSpeciesNames[50],
      ...
      'photoHeading': 0,
      'photoPitch': 35,
      'varieties': ((20, FLOWER_LAVENDER, 5), (21, FLOWER_CRIMSON, 6), (22, FLOWER_LEMON, 8))},
 ...
 55: {'name': TTLocalizer.FlowerSpeciesNames[55],
      ...
      'photoHeading': -20,
      'photoPitch': 35,
      'varieties': ((70, FLOWER_TEAL, 7), (71, FLOWER_TAUPE, 8))},
