...
UberdogPurgePartyPeriod = 24.0  # in minutes, how often we purge parties
...
PhaseToMusicData = {
    ...
    4: {
        ...
        # "MG_Pairing.ogg" : [TTLocalizer.MusicMgPairing, 60],
        "TC_nbrhood.ogg": [TTLocalizer.MusicTcNbrhood, 59],
        # "MG_Diving.ogg" : [TTLocalizer.MusicMgDiving, 30],
        ...
        # "MG_Travel.ogg" : [TTLocalizer.MusicMgTravel, 31],
        # "MG_tug_o_war.ogg" : [TTLocalizer.MusicMgTugOWar, 29],
        "MG_Vine.ogg": [TTLocalizer.MusicMgVine, 32],
        # "MG_IceGame.ogg" : [TTLocalizer.MusicMgIcegame, 56],
        # "MG_toontag.ogg" : [TTLocalizer.MusicMgToontag, 57],
        # "m_match_bg2.ogg" : [TTLocalizer.MusicMMatchBg2, 9],
        # "MG_Target.ogg" : [TTLocalizer.MusicMgTarget, 30],
    ...
    6: {
        ...
        # "DD_SZ_activity.ogg" : [TTLocalizer.MusicDdSzActivity, 62],
    },
    # 7 : {
    # "encntr_general_bg_indoor.ogg" : [TTLocalizer.MusicEncntrGeneralBgIndoor, 31],
    # "tt_elevator.ogg" : [TTLocalizer.MusicTtElevator, 12],
    # "encntr_toon_winning_indoor.ogg" : [TTLocalizer.MusicEncntrToonWinningIndoor, 32],
    # "encntr_general_suit_winning_indoor.ogg" : [TTLocalizer.MusicEncntrGeneralSuitWinningIndoor, 36],
    # },
    8: {
        ...
        # "TB_SZ_activity.ogg" : [TTLocalizer.MusicTbSzActivity, 48],
        "TB_SZ.ogg": [TTLocalizer.MusicTbSz, 54],
        # "DG_nbrhood.ogg" : [TTLocalizer.MusicDgNbrhood, 55],
    },
    9: {
        "encntr_hall_of_fame.ogg": [TTLocalizer.MusicEncntrHallOfFame, 51],
        # "encntr_suit_HQ_nbrhood.ogg" : [TTLocalizer.MusicEncntrSuitHqNbrhood, 42],
        # "CHQ_FACT_bg.ogg" : [TTLocalizer.MusicChqFactBg, 50],
        # "CogHQ_finale.ogg" : [TTLocalizer.MusicCoghqFinale, 64], # WARNING CogHQ_finale.ogg is broken, don't use
    ...
    # 12 : {
    # "BossBot_CEO_v2.ogg" : [TTLocalizer.MusicBossbotCeoV2, 31],
    ...
    13: {
        ...
        # "party_swing_dance.ogg" : [TTLocalizer.MusicPartySwingDance, 62],
        ...
        # "party_generic_theme.ogg" : [TTLocalizer.MusicPartyGenericTheme, 65],
    },
}
