...
class DistributedPartyCatchActivity(DistributedPartyActivity, DistributedPartyCatchActivityBase):
    ...
    def load(self, loadModels=1, arenaModel="partyCatchTree"):
        ...
        self.notify.debug("PartyCatch: load")
        ...
        self._avatarNodePathParentToken = 'PartyCatch-%s' % self.doId
    ...
    def handleToonDisabled(self, avId):
        ...
        self.notify.debug("handleToonDisabled")
    ...
    def setState(self, newState, timestamp):
        ...
        self.notify.debug("setState( newState=%s, ... )" % newState)
    ...
    def __handleCatch(self, generation, objNum):
        self.notify.debug("catch: %s" % [generation, objNum])
...
# self.showMessage(TTLocalizer.PartyCatchCannotStart)
    ...
    def startIdle(self):
        self.notify.debug("startIdle")

    def finishIdle(self):
        self.notify.debug("finishIdle")
