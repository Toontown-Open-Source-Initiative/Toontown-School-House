...
# -------------------------------------------------------------------------------
from panda3d.core import Vec3, Vec4, Point3, TextNode

from direct.directnotify import DirectNotifyGlobal
from direct.gui.DirectGui import DGG, DirectFrame, DirectButton, DirectLabel, DirectScrolledList
...
class PublicPartyGui(DirectFrame):
    ...
    """
    notify = DirectNotifyGlobal.directNotify.newCategory("PublicPartyGui")
    ...
    def createListAndLabel(self, typeString, numItems):
        ...
        typeString : "guests", "activities", "decorations"
        """
    ...
    def destroy(self):
        ...
        try:
            ...
            # an empty list will not have items
            pass
        self.activityList.removeAndDestroyAllItems()
        del self.partyList
