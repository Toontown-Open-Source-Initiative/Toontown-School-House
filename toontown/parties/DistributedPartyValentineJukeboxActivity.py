...
class DistributedPartyValentineJukeboxActivity(DistributedPartyJukeboxActivityBase):
    notify = directNotify.newCategory("DistributedPartyValentineJukeboxActivity")
    ...
    def load(self):
        ...
        newTexture = loader.loadTexture("phase_13/maps/tt_t_ara_pty_jukeboxValentineA.jpg",
