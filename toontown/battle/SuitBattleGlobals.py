...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
       ...
       'hp':(12,24,40,60,84), # cogs hp (more numbers, more levels)
       ...
       'attacks':
                (('GlowerPower',
                    (20,25,30,40,60), # attack damage
                    (75,75,80,80,90), # attack accuracy
                    (30,30,30,30,30)), # move frequency (all move frequency of each attack must add up to 100, for example 30,10,60 from level 1 of each attack)
                ('EvilEye',
                    (12,15,18,21,24),
                    (60,70,75,80,90),
                    (40,40,40,40,40)),
 ...
 'tbc': {'name': TTLocalizer.SuitTheBigCheese,
         ...
         'level': 7,
         'hp':(45,55,66,78,100,150,200,250,300,350,400,450,500,550),
