...
SuitAttacks = {'Audit': ('phone', ATK_TGT_SINGLE),
 ...
 'Schmooze': ('glower', ATK_TGT_SINGLE),
 ...
 'Screech': ('glower', ATK_TGT_GROUP),
 'Moth': ('effort', ATK_TGT_SINGLE)}
...
SCREECH = SuitAttacks.keys().index('Screech')
MOTH = SuitAttacks.keys().index('Moth')
