...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
 ...
 'tbc': {'name': TTLocalizer.SuitTheBigCheese,
         ...
         'level': 7,
         'hp':(90,110,132,156,200,250,350,500),
         'def':(35,40,45,50,55,60,65,70),
         'freq':(50,30,10,5,5,5,5,5),
         'acc':(35,40,45,50,55,60,65,70),
         'attacks':
                (('GlowerPower',
                    (16,18,20,22,24,28,33,38),
                    (55,55,65,65,75,75,85,90),
                    (20,20,20,20,20,20,20,20)),
                ('TeeOff',
                    (8,11,14,17,20,21,21,22),
                    (55,65,70,75,80,85,90,90),
                    (40,40,40,40,40,40,40,40)),
                ('ParadigmShift',
                    (12,15,18,21,24,27,30,33),
                    (50,50,60,60,65,70,75,80),
                    (40,40,40,40,40,40,40,40)))},
