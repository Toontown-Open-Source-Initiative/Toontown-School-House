...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
 ...
 'm': {'name': TTLocalizer.SuitTheMingler,
       ...
       'level': 0,
       'hp':(6,12,20,30,42,56,72,90,110,132,156),
       'def':(2,5,10,15,20,25,30,35,40,45,50),
       'freq':(0,0,0,0,0,0,50,30,10,5,5),
       'acc':(35,35,35,35,35,35,35,40,45,50,55),
       'attacks':
               (('ParadigmShift',
                    (14,0,0,0,0,0,0,12,15,18,21,100),
                    (100,0,0,0,0,0,60,70,75,80,80),
