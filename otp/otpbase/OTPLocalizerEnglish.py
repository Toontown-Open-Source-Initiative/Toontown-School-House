...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
 ...
 'ms': ['Get ready for a shake down.',
        ...
        'Are you shaking yet?'],
 'hh': ["I may look like a vulture but trust me, I'm a dove.",
        "Here to give me some crackers?",
        "Give me some bread.",
        "Squaak!",
        "My eyes are up here, you worm!",
        'Look up!',
        "You're soaring for trouble.",
        "You'll be a great snack.",
        "Don't call me dumb. Your the worm brain here!",
        "Don't rustle my feathers.",
        "Don't crawl!"],
 ...
 'mh': ['I am the scheme!',
        'Hehe, talk to my lawyer',
        "Let's get the show rolling!",
        'Today, you will give ME money',
        'I already told you, no refunds',
        'Oh please... You toons scam yourselves all the time',
        'Are you ready for bankruptcy?',
        "Stop bugging me.",
        'I told you not to call me.',
        "Let's keep this quiet, okay?",
        "There's no business like it!",
        "I hope you don't who did this to you."],
 ...
 'bw': ["EnD mE!",
        ...
        "i WaS mInGlEd!",
        "HeY sIsTeRs.",
        "I tHiNk ThIs MaKeUp Is DrIvInG mE iNsAnE.",
        "i Am PrEtTy."],
 ...
 'sd': ["I've already answered the damn phone!",
        'Tell Nurse Shark to shut the hell up!',
        'Piss off already. I am not answering your calls!',
        'Im going to make you stop calling.',
        'Take the hint. I dont want to talk to you',
        'Stupid Toon, telephone please, Stupid Toon',
        "That's it, you're getting it!",
        'Please... Stop calling my number.',
        'Please... Just stop calling.',
        'I will answer the phone on my own time'],
 'f': ["I'm gonna tell the boss about you!",
       ...
       "Can you believe it! I don't need glasses anymore!",
 ...
 'p': ["I'm gonna rub you out!",
       ...
       "I swear to god, if you make fun of my name...",
       "I'm going to scratch you out.",
       "I'll have to make my point more clear.",
       'Ready to feel this bi-. That sounded better in my head.',
       "Please just... stop it with the tip jokes.",
       'I hate it when things get dull.',
       'Erase me, if you can.',
       'Did you pencil me in?',
       'I will stab you with my ti-. I need to stop, dont I.'],
 'ym': ["I'm positive you're not going to like this.",
        "I'm a Yesm- PIIIIIIINK",
        'PINK',
        'pink',
        "Ye- PINK",
        "piNK",
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 1206: 'I need more Scams.',
 1207: 'I need more Sellbot Suit Parts.',
 1208: "This isn't what you need.",
 1209: 'I found what you need.',
 1210: 'I need more Laundered Money.',
 1211: 'I need more Wrongful Convictions.',
