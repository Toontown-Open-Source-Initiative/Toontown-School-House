...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
 ...
 'm': ["PARADIGM SHIT!",
       'You want that key so bad?',
       'Fuck you, kid!',
       "lEt'S mUnGlE.",
       'This looks like a good place to mungle.',
       "MUNGLING TIME",
       "You're mungling with defeat.",
       "I'm going to mungle in your private parts!",
       "You're ass is mine to mungle!"],
 ...
 'cr': ['Why did I invest in two eyepatches?',
        "I'm Blindbeard the pirate!",
        'Prepare to be blinded!',
        "I don't need eyes to see your demise.",
        "You'll wish you were'nt fighting a blind guy!",
        "You're looking rather vulnerable. Maybe.",
        "I'm gonna rob you blind!",
        "I'm looking the right way, am I?",
        'Promise you stand still when I attack?',
        "I don't see shit."],
 'mh': ['I am Master Ant! Fear me!',
        'Pick on someone your own size!',
        "Your'e not gonna step on me!",
        'Who did you expect? Paul Rudd?',
        'This is gonna be like Attack on Titan!',
        'The bigger they are, the harder they fall!',
        'No ant farm can contain me!',
        "Ants can lift things ten times their size.",
        'Do not underestimate my might!',
        "Good things come in small packages.",
        "Keep laughing at my size. You won't laugh long.",
        "Who did you expect? Paul Rudd?"],
 'nc': ['LeT iT gOoOoOoO',
        'The toons never bothered me anyway.',
        "Don't give me that cold stare!",
        'I will sing my lungs out if I have to.',
        "Stay cool.",
        'Insert ice pun here.',
 ...
 'bw': ["Come get some grains friend.",
        'Finish your oatmeal, toon.',
        'Rise and shine!',
        "Killing you is the right thing to do!",
 ...
 'le': ["I'll slap the McShit outta you!",
        'I soar, then I score.',
 ...
 'sd': ['I love fresh meat!',
        'Hey toon. Want some candy?',
        "My name is Jared and I'm still lookin' good!",
        "My meatballs are better than Loopy's!",
        'Want a taste of my foot-long?',
        'Time to touch you uncomfortably!',
        "I lost all this weight by chasing toons like you!",
        "I'm not into animal children, but I'll hit that anyway!",
        'Is there a sandwich under your skirt?',
        'I like my toons like I like my sandwiches, with extra mayo between buns!'],
 'f': ["I'm gonna tell mommy about you!",
       "I may be just a baby - But you'll be crying much sooner.",
       "I'm using you to step up the high chair.",
       "You're not going to like what's in my diaper.",
 ...
 'mm': ["I'm going to get into your pants!",
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 1115: "Let's go fight the VM!",
 1116: "Let's go in the Factory!",
 1117: "Let's go fishing!",
 1118: "Let's go fishing at my house!",
 1119: "Let's go to Disneybot HQ!",
 1120: "Let's go fight Mecha Mickey!",
 1121: "Let's go in the Castle!",
 1122: "Let's go to Chefbot HQ!",
 1123: "Let's go fight Rordon Gamsay!",
 1124: "Let's go in the Kitchen of Nightmares!",
 1125: "Let's go to %s!" % lOutdoorZone,
 1126: "Let's go to %s!" % lGolfZone,
 1127: "Let's go to Glitchbot HQ!",
 1128: "Let's go fight the Glitch King!",
 ...
 1206: 'I need more Mingle Money.',
 1207: 'I need more Sellbot Suit Parts.',
 1208: "This isn't what you need.",
 1209: 'I found what you need.',
 1210: 'I need more Mousebucks.',
 1211: 'I need more Ingredients.',
 1212: 'I need more Bugs.',
