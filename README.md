...
# Panda3D
This source code requires a customized version of Panda3D to run. Here are links to the 32 and 64 bit Windows executables. Please contact the teachers on our Discord server for instructions on the Linux Panda3D setup. For MacOSX Panda3D setup instructions please contact Darth Nihilus on our Discord server. 
